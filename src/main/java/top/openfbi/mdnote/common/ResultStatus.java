...
public enum ResultStatus implements IResultStatus {
    ...
    // 12xx 文件上传失败
    FILE_CONTENT_NULL(1200,"文件为空，上传失败"),
    FILE_NAME_FALL(1201,"文件名为空，上传失败"),
    QI_NIU_FILE_UPLOAD_FALL(1202,"七牛云图片上传错误"),
    FILE_READ_FALL(1203,"文件读取错误，上传失败"),
    FILE_SAVE_FALL(1204,"文件保存错误，上传失败"),
    FILE_HASH_COLLISION_TOO_MUCH(1205,"图片hash冲突次数超限"),
